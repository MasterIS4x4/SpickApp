import {IonButtons, IonContent, IonHeader, IonImg, IonItem, IonList, IonMenu, IonMenuButton, IonMenuToggle, IonPage, IonTitle, IonToolbar} from "@ionic/react"
  ...
  return (
    <>
      <IonMenu menuId="left-menu" contentId="main-content">
        <IonHeader>
          <IonToolbar>
            <IonImg slot="start" src={basePath + "spickapp-small.png"} style={{width: "auto", height: 40, marginLeft: "1em"}} />
